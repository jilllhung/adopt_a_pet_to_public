...
public class PetService {
	...
	public void dummyPetToDataBase() {
		...
		newPet1.setAgeGrp(ageGroupServ.getAgeGroupByName("Young"));
		...
		newPet2.setAgeGrp(ageGroupServ.getAgeGroupByName("Senior"));
		Pet newPet3 = new Pet("Clifford", "Red", "Sunnyvale", "CA", "95616", "https://i.guim.co.uk/img/media/fe1e34da640c5c56ed16f76ce6f994fa9343d09d/0_174_3408_2046/master/3408.jpg?width=120&quality=45&auto=format&fit=max&dpr=2&s=064680b85e72644d9cc2e69e2763c541");
		newPet3.setAgeGrp(ageGroupServ.getAgeGroupByName("Senior"));
	}
